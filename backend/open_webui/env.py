...
SWARMUI_CFG_SCALE = float(os.environ.get("SWARMUI_CFG_SCALE", "1.0"))
SWARMUI_SAMPLER = os.environ.get("SWARMUI_SAMPLER", "")
SWARMUI_SCHEDULER = os.environ.get("SWARMUI_SCHEDULER", "")
SWARMUI_PRESET = os.environ.get("SWARMUI_PRESET", "")
